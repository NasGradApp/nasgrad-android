...
interface ApiClient {
    ...
    @GET("getIssueList/UpdateIssueStatus")
    fun updateIssueStatus(@Path("id") id : String, @Path("statusId") statusId: Int): Observable<Issue>
    ...
    companion object {
        ...
        fun create(): ApiClient {
            val retrofit = Retrofit.Builder()
                    ...
                    .baseUrl("https://nasgrad.app:8081/api/")
                    .build()
